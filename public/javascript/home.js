    ...
    body_page.insertAdjacentHTML("afterbegin",
        ...
        <div id="banner">
          <div id="bannertext">
            ...
            <a href="profile.html" class="btn btn-outline-success">เข้าร่วม</a>
          </div>
        </div>
          ...
          <div class="col-sm-4 col-lg-4" data-aos="fade-up">
            <article class="card card--1">
              ...
              <div class="card__info">
                ...
                <a href="content_01.html" class="btn btn-outline-success">อ่านเพิ่มเติม</a>
              </div>
            </article>
          </div>
          <div class="col-sm-4 col-lg-4" data-aos="fade-up">
          ...
          <div class="row align-items-start footer-text-l">
            ...
            <div class="row align-items-start">
              <div class="col-12 col-sm-6 col-md-6 col-lg-6" id="icon-contact">
                ...
                <a href="https://twitter.com/KaponPang" target="_blank"><img src="/public/IMG/icon/facebook-app-logo.svg"
                    alt=""></a>
                <a href="https://www.instagram.com/k.panggg/" target="_blank"><img src="/public/IMG/icon/instagram.svg"
                    alt=""></a>
              </div>
